...
//        reloadSubscribed();
        ...
        MultipartBody.Builder multipartBuilder = new MultipartBody.Builder()
                ...
                .addFormDataPart("publishers_id", subscriber.getId().getPublishers().getId() + "");
            ...
            public void onResponse(Call arg0, Response arg1) throws IOException {
                ...
                if (!result.equals(""))
                    try {
                        ...
                        ContentIdolsActivity.this.runOnUiThread(new Runnable() {
                            public void run() {
                        ...
                        ContentIdolsActivity.this.runOnUiThread(new Runnable() {
                            public void run() {
                                new AlertDialog.Builder(ContentIdolsActivity.this)
